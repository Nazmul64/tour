                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 text-center">
                                        @if(Auth::guard('admin')->user()->photo)
                                            <img src="{{ asset('uploads/' . Auth::guard('admin')->user()->photo) }}" alt="Profile Photo" class="img-thumbnail mb-2" style="max-width: 100%;">
                                        @else
                                            <img src="{{ asset('uploads/default.png') }}" alt="Profile Photo" class="img-thumbnail mb-2" style="max-width: 100%;">
                                        @endif
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <button class="btn btn-outline-secondary" type="button" onclick="togglePassword('confirm_password', this)">👁️</button>
                                            </div>
                                        </div>
